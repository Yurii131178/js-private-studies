...
console.log(add(130, 97, 6, 52, 1, 0, 13, false));
console.log(add(130, 97, 6, 52, 1, 0, 13, true));
console.log(add(130, 97, 6, 52, 1, 0, 13, true, "12"));
console.log(add(130, 97, 6, 52, 1, 0, 13, true, "12", "WTF"));
...
function addOverNum(value, ...args) {
  let total = 0; // Ініціалізація змінної для суми
  for (const num of args) {
    if (num > value) { // Порівнюємо кожен аргумент із першим числом
      total += num; // Додаємо до загальної суми
    }
  }
  return total; // Повертаємо результат
}
// Оголошена функція addOverNum()
console.log(addOverNum(50, 15, 27)); // Виклик повертає 0
console.log(addOverNum(10, 12, 4, 11, 48, 10, 8)); //Виклик  повертає 71
console.log(addOverNum(15, 32, 6, 13, 19, 8)); // Виклик повертає 51
console.log(addOverNum(20, 74, 11, 62, 46, 12, 36)); // Виклик повертає 218


console.log("синтаксис ...spread");
...
function getExtremeScores(scores) {
  console.log(scores); // тут у нас масив !!!тільки для інформації!!!
    console.log(...scores); // перетворюємо на список !!!тільки для інформації!!!
  let best = Math.max(...scores); // вибираємо зі списку макс.число
  let worst = Math.min(...scores); // вибираємо зі списку мін.число
  return {best, worst} // повертаємо об'єкт з макс. і мін.
}

console.log(getExtremeScores([89, 64, 42, 17, 93, 51, 26])); //{"best": 93, "worst": 17}//
console.log(getExtremeScores([19, 7, 4, 17, 81, 24])); //{"best": 93, "worst": 17}//
